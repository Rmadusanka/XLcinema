            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form action="removeAdminF.php" method="POST" class="form-horizontal form-label-left" novalidate>
                      <div class="title_right">
                        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                          <div class="input-group">
                            <input id="empNo" name="empNo" type="text" class="form-control" placeholder="Emp No">
                            <span class="input-group-btn">
                              <button id="remove" type="submit" class="btn btn-default">Remove</button>
                            </span>
                          </div>
                        </div>
                      </div>
