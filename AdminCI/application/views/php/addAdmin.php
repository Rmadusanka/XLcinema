                    ...
                    <!--<form action="addEmpF.php" method="POST" class="form-horizontal form-label-left" novalidate>-->
                      <table width="80%">
                          <tr>
                            ...
                            <td  width="50%" >
                              <input class="form-control col-md-7 col-xs-12" id="empNo" name="empNo" required="required" type="text">
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <input id="uname" name="uname" class="form-control col-md-7 col-xs-12" required="required" type="text">
                            </td>
                          </tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <input id="type" name="type" class="form-control col-md-7 col-xs-12" required="required" type="text"<?php echo "value='Admin'>";?>
                          </td>
                        </tr>

                          <tr>
                            <td></td>
                            <td><button id="send" type="submit" class="btn btn-success">Add</button></td></tr>
                      </table>
                  </div>
                </div>
              </div>
