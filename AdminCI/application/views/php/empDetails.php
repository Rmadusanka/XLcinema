              ...
              <div class="title_left">
                <h3>Employee Details</h3>
                  ...
                  <div class="title_right">
                        <?php echo form_open('Employee/search_emp')?>
                          <span class="input-group-btn">
                            <table border=1 class="table table-bordered" >
                              <thead style="background-color:     #D3D3D3;">
                                <tr>
                                    <th><input id="empNo" name="empNo" type="text" class="form-control" placeholder="Emp No"></th>
                                    <th><button id="search" name="search" type="submit" class="btn btn-default" value="search">Search</button></th>
                                  </tr>
                            </table>
                          </span>
                        <?php echo form_close()?>
                    ...
                    <div class="table-responsive">
                      ...
                      <?php
                        foreach ($result as $r):
                          ...
                          echo '<td>
                                <a href="Employee/remove_emp" id="$r->id" class="deleteuser"><button value="delete" onclick="return confirm("Are you sure  to Delete?")">Delete</button></a>
                                  </td>';
                          echo "</tr>";
                        endforeach;
                      ?>
