              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open('Employee/update_emp' ) ?>
                      <div class="x_content" >
                      <table width="80%" >
                        <?php
                          foreach($result as $r):?>
                            ...
                            <tr>
                              ...
                              <td>
                                <input id="name" name="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="10" readonly="readonly" type="text"   
                            ...
                            <tr>
                              <td>
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">NIC <span class="required">*</span></label>
                              </td>
                              <td>
                                <input type="nic" id="nic" name="nic" required="required" data-validate-minmax="10,10" class="form-control col-md-7 col-xs-12" readonly="readonly"
                                value=<?php echo $r->NIC;?>>
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td>
                                <input type="tel" id="telephone" name="phone" required="required" data-validate-length-range="10,12" class="form-control col-md-7 col-xs-12" 
